...
<center>
```{r, echo=FALSE, results='hide', fig.width=7, fig.height=3, fig.align="center",  warning=FALSE, message=FALSE}
...
<center>
```{r, echo=FALSE, results='hide', fig.width=7, fig.height=3, fig.align="center"}
